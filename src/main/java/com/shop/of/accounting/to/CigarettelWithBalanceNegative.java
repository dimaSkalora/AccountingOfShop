...
public class CigarettelWithBalanceNegative extends BaseTo{
    ...
    public CigarettelWithBalanceNegative(Integer id, LocalDate goodsReceiptDate, String category, String productName, Integer amount, Integer balanceOnTheFirstDayOfTheMonth, Integer receivedForMonth, Integer soldForMonth, Integer balanceOnTheLastDayOfTheMonth, boolean balanceNegative) {
        super(id);
    ...
    public String toString() {
        return "CigarettelWithBalanceNegative{" +
