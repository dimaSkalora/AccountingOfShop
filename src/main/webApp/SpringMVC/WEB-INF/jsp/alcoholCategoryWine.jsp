...
<div class="jumbotron">
    <div class="container">
        <h3 class="text-center"><spring:message code="alcohol.alcoholCategoryWine"/> </h3>
        <div class="row">
            <div class="col-sm-6">
                                    ...
                                    <td colspan="2">
                                        <c:if test="${!empty alcohol.id}">
                                            <input class="btn btn-primary" type="submit"
                                                   value="<spring:message code="alcohol.editWine"/>"/>
                                        </c:if>
                                        <c:if test="${empty alcohol.id}">
                                            <input class="btn btn-primary" type="submit"
                                                   value="<spring:message code="alcohol.addWine"/>"/>
                                        </c:if>
                                    </td>
                                </tr>
                                </tbody>
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${categoryWine}" var="alcohol">
                    ...
                    <tr class="${alcohol.balanceNegative ? 'reduced' : 'normal'}">
                        ...
                        <td><A href="alcoholCategoryWine/update?id=${alcohol.id}"/><spring:message code="alcohol.update"/></td>
                        <td><A href="alcoholCategoryWine/delete?id=${alcohol.id}"/><spring:message code="alcohol.delete"/></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
