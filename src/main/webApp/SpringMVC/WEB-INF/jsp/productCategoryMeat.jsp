...
<div class="jumbotron">
    <div class="container">
        <h3 class="text-center">Product Category Meat</h3>
        <div class="row">
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <c:url var="addAction" value="/productCategoryMeat/saveMeat"/>
                        <form:form action="${addAction}" commandName="product" cssClass="form-horizontal">
                            <table class="table">
                                <tbody>
                                    ...
                                    <td colspan="2">
                                        <c:if test="${!empty product.id}">
                                            <input class="btn btn-primary" type="submit"
                                                   value="<spring:message text="Update Category Meat"/>"/>
                                        </c:if>
                                        <c:if test="${empty product.id}">
                                            <input class="btn btn-primary" type="submit"
                                                   value="<spring:message text="Add Category Meat"/>"/>
                                        </c:if>
                                    </td>
                                </tr>
                                </tbody>
            ...
            <div class="col-sm-4">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form method="post" action="productCategoryMeat/searchByProductName">
                            <dl>
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${categoryMeat}" var="product">
                    ...
                    <tr class="${product.balanceNegative ? 'reduced' : 'normal'}">
                        ...
                        <td><A href="productCategoryMeat/update?id=${product.id}"/>update</td>
                        <td><A href="productCategoryMeat/delete?id=${product.id}"/>delete</td>
                    </tr>
                </c:forEach>
            </table>
        </div>
